...
data{
  ...
  matrix[Nt-1, Ns] fallow; //fallow covariate
  matrix[Nt-1, Ns] spei; //pond mean
...
parameters{
  ...
  real alpha_hm; //Adult harvest mortality intercept
  real alpha_nm; //Adult natural mortality intercept
  real alpha_hm_j; //Juvenile harvest mortality intercept
  real alpha_nm_j; //Juvenile natural mortality intercept
...
transformed parameters{
  ...
  matrix[Nt-1, Ns] nm; //Adult natural mortality hazard rate
  matrix[Nt, Ns] hm; //Adult harvest mortality hazard rate
  matrix[Nt-1, Ns] nm_j; //Juvenile natural mortality hazard rate
  ...
  matrix<lower=0, upper=1>[Nt-1, Ns] eta; //Natural mortality probability
  ...
  matrix<lower=0, upper=1>[Nt-1, Ns] eta_j; //Juvenile Natural mortality probability
